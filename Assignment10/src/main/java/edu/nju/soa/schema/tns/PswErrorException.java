...
public class PswErrorException
    extends Exception
{
     ...
     * @param message
     */
    public PswErrorException(String message, AuthFaultType faultInfo) {
        super(message);
     ...
     * @param message
     */
    public PswErrorException(String message, AuthFaultType faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
